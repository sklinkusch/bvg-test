  ...
  _createClass(Direction, [{
    ...
    value: function getDirection() {
      this.direction = {
        ...
        BTOR: {
          stop: [900000100025],
          filter: [[this.getStation(this.S1, "ORB", "LEN", "BOR", "BIW", "HN", "FOH", "HED", "WAI", "WIN", "WM", "SNH", "WOK", "BOS", "GB", "HUM", "NB", "ORS", "FSTT"), this.getStation(this.S2, "BER", "BRF", "ZEP", "RGT", "BU", "KRW", "BLB", "PHD", "PKW", "BOS", "GB", "HUM", "NB", "ORS", "FSTT"), this.getStation(this.S25, "HD", "HLS", "SZF", "TG", "EBD", "KBO", "ARF", "SNH", "WOK", "BOS", "GB", "HUM", "NB", "ORS", "FSTT"), this.getStation(this.S26, "WAI", "WIN", "WM", "SNH", "WOK", "BOS", "GB", "HUM", "NB", "ORS", "FSTT"), this.getStation(this.S1, "PDH", "BAB", "GRI", "WSS", "NIW", "SLS", "MEX", "ZD", "SDG", "LWE", "BGT", "RST", "FB", "FRU", "SGV", "JLB", "YOR", "AHU", "POP"), this.getStation(this.S2, "BFD", "MAH", "LRD", "SC", "BCH", "MF", "ATS", "PRS", "SKV", "YOR", "AHU", "POP"), this.getStation(this.S25, "TLS", "LIS", "OSS", "LIO", "LAK", "SDE", "PRS", "SKV", "YOR", "AHU", "POP"), this.getStation(this.S26, "TLS", "LIS", "OSS", "LIO", "LAK", "SDE", "PRS", "SKV", "YOR", "AHU", "POP"), this.getStation(this.U55, "NULL"), this.getTerminus("TXL", "Flughafen Tegel"), this.getTerminus("100", "Zoologischer Garten"), this.getTerminus("TXL", "Alexanderplatz"), this.getTerminus("100", "Alexanderplatz")]]
        },
        BBUP: {
          stop: [900000044202],
        ...
        BCHS: {
          stop: [900000024101, 900000024202, 900000024205, 900000024103],
          filter: [[this.getTerminus("RE1", "Magdeburg", "Brandenburg", "Potsdam"), this.getTerminus("RE2", "Wismar", "Bad Kleinen", "Schwerin", "Wittenberge"), this.getTerminus("RE7", "Dessau", "Bad Belzig"), this.getTerminus("RB14", "Nauen"), this.getTerminus("RB21", "Wustermark", "Golm", "Potsdam"), this.getTerminus("RB22", "Königs Wusterhausen", "Schönefeld", "Golm", "Potsdam"), this.getTerminus("RE1", "Cottbus", "Eisenhüttenstadt", "Frankfurt"), this.getTerminus("RE2", "Cottbus"), this.getTerminus("RE7", "Wünsdorf-Waldstadt", "Schönefeld"), this.getTerminus("RB14", "Schönefeld"), this.getTerminus("RB21", "Friedrichstr"), this.getTerminus("RB22", "Friedrichstr"), this.getStation(this.S3, "GWD", "SPA", "SRW", "PIC", "OLS", "HST", "MS", "WKS"), this.getStation(this.S5, "GWD", "OLS", "HST", "MS", "WKS"), this.getStation(this.S7, "OLS", "HST", "MS", "PDH", "BAB", "GRI", "WSS", "NIS", "GWD", "WKS"), this.getStation(this.S9, "GWD", "SPA", "SRW", "PIC", "OLS", "HST", "MS", "WKS"), this.getStation(this.S3, "E", "WIG", "RD", "FRH", "HIG", "KPK", "WHH", "KLH", "RB", "RH", "OKS", "WRS", "OSB", "JB", "ALX", "HKM", "FST", "HBF", "BEV", "TGN", "ZOS", "SAP"), this.getStation(this.S5, "STN", "STR", "HGM", "STV", "PEN", "FD", "NG", "HPG", "BIS", "MDF", "KAD", "WT", "BDF", "FFO", "LI", "NPL", "OKS", "WRS", "OSB", "JB", "ALX", "HKM", "FST", "HBF", "BEV", "TGN", "ZOS", "SAP"), this.getStation(this.S7, "AF", "MEA", "RW", "MAZ", "POE", "SPH", "FFO", "LI", "NPL", "OKS", "WRS", "OSB", "JB", "ALX", "HKM", "FST", "HBF", "BEV", "TGN", "ZOS", "SAP"), this.getStation(this.S9, "LI", "NPL", "OKS", "GAS", "FLH", "GBA", "AGL", "ADL", "SCF", "SW", "BMW", "PWA", "TP", "WRS", "OSB", "JB", "ALX", "HKM", "FST", "HBF", "BEV", "TGN", "ZOS", "SAP"), this.getTerminus("X49", "U Wilmersdorfer Str"), this.getTerminus("309", "U Wilmersdorfer Str")], [this.getStation(this.U7, "RSp", "AS", "Zi", "Hs", "P", "Rm", "Sie", "Hl", "JK", "Jh", "Mp", "Rw", "Bmu"), this.getStation(this.U7, "R", "Zd", "Wk", "La", "Jt", "Br", "Pi", "Bl", "Gz", "Nk", "KM", "Rk", "Hpu", "Sü", "Gs", "Me", "Mu", "Y", "Kt", "Ei", "Bpu", "Beu", "Bli", "Fpu", "Kn", "Ad")], [this.getTerminus("X49", null), this.getTerminus("309", null), this.getTerminus("310", null)], [this.getTerminus("109", "Flughafen Tegel"), this.getTerminus("310", null), this.getTerminus("N7", "Rathaus Spandau"), this.getTerminus("109", "Zoologischer Garten"), this.getTerminus("N7", "Schönefeld", "Rudow")]]
        },
        BFA: {
          stop: [900000120001],
        ...
        BHST: {
          stop: [900000026105],
          filter: [[this.getStation(this.S3, "SPA", "SRW", "PIC", "OLS"), this.getStation(this.S5, "OLS"), this.getStation(this.S7, "OLS"), this.getStation(this.S9, "SPA", "SRW", "PIC", "OLS"), this.getStation(this.S3, "E", "WIG", "RD", "FRH", "HIG", "KPK", "WHH", "KLH", "RB", "RH", "OKS", "WRS", "OSB", "JB", "ALX", "HKM", "FST", "HBF", "BEV", "TGN", "ZOS", "SAP", "CHS", "WKS", "MS"), this.getStation(this.S5, "STN", "STR", "HGM", "STV", "PEN", "FD", "NG", "HPG", "BIS", "MDF", "KAD", "WT", "BDF", "FFO", "LI", "NPL", "OKS", "WRS", "OSB", "JB", "ALX", "HKM", "FST", "HBF", "BEV", "TGN", "ZOS", "SAP", "CHS", "WKS", "MS"), this.getStation(this.S7, "AF", "MEA", "RW", "MAZ", "POE", "SPH", "FFO", "LI", "NPL", "OKS", "WRS", "OSB", "JB", "ALX", "HKM", "FST", "HBF", "BEV", "TGN", "ZOS", "SAP", "CHS", "WKS", "MS"), this.getStation(this.S9, "LI", "NPL", "OKS", "GAS", "FLH", "GBA", "AGL", "ADL", "SCF", "SW", "BMW", "PWA", "TP", "WRS", "OSB", "JB", "ALX", "HKM", "FST", "HBF", "BEV", "TGN", "ZOS", "SAP", "CHS", "WKS", "MS"), this.getTerminus("M49", "Nennhauser Damm", "Reimerweg", "Gatower Str"), this.getTerminus("X34", "Hottengrund", "Gutsstr", "Alt-Kladow", "Gatower Str"), this.getTerminus("X49", "Hahneberg", "Im Spektefeld", "Gatower Str"), this.getTerminus("218", "Pfaueninsel"), this.getTerminus("M49", "Zoologischer Garten", "Savignyplatz", "Wilmersdorfer Str", "Haus des Rundfunks"), this.getTerminus("X34", "Zoologischer Garten", "Savignyplatz", "Wilmersdorfer Str"), this.getTerminus("X49", "Wilmersdorfer Str"), this.getTerminus("218", "Messe Nord/ICC"), this.getTerminus("349", "Grunewald")]]
        },
        BHEI: {
          stop: [900000045102],
        ...
        BHUM: {
          stop: [900000008101],
          filter: [[this.getStation(this.S1, "ORB", "LEN", "BOR", "BIW", "HN", "FOH", "HED", "WAI", "WIN", "WM", "SNH", "WOK", "BOS", "GB"), this.getStation(this.S2, "BER", "BRF", "ZEP", "RGT", "BU", "KRW", "BLB", "PHD", "PKW", "BOS", "GB"), this.getStation(this.S25, "HD", "HLS", "SZF", "TG", "EBD", "KBO", "ARF", "SNH", "WOK", "BOS", "GB"), this.getStation(this.S26, "WAI", "WIN", "WM", "SNH", "WOK", "BOS", "GB"), this.getStation(this.S1, "PDH", "BAB", "GRI", "WSS", "NIW", "SLS", "MEX", "ZD", "SDG", "LWE", "BGT", "RST", "FB", "FRU", "SGV", "JLB", "YOR", "AHU", "POP", "TOR", "FSTT", "ORS", "NB"), this.getStation(this.S2, "BFD", "MAH", "LRD", "SC", "BCH", "MF", "ATS", "PRS", "SKV", "YOR", "AHU", "POP", "TOR", "FSTT", "ORS", "NB"), this.getStation(this.S25, "TLS", "LIS", "OSS", "LIO", "LAK", "SDE", "PRS", "SKV", "YOR", "AHU", "POP", "TOR", "FSTT", "ORS", "NB"), this.getStation(this.S26, "TLS", "LIS", "OSS", "LIO", "LAK", "SDE", "PRS", "SKV", "YOR", "AHU", "POP", "TOR", "FSTT", "ORS", "NB"), this.getTerminus("247", "Nordbahnhof", "Bernauer Str"), this.getTerminus("247", "Leopoldplatz")]]
        },
        BIP: {
          stop: [900000054105],
        ...
        BMS: {
          stop: [900000025423],
          filter: [[this.getStation(this.S3, "SPA", "SRW", "PIC", "OLS", "HST"), this.getStation(this.S5, "OLS", "HST"), this.getStation(this.S7, "OLS", "HST"), this.getStation(this.S9, "SPA", "SRW", "PIC", "OLS", "HST"), this.getStation(this.S3, "E", "WIG", "RD", "FRH", "HIG", "KPK", "WHH", "KLH", "RB", "RH", "OKS", "WRS", "OSB", "JB", "ALX", "HKM", "FST", "HBF", "BEV", "TGN", "ZOS", "SAP", "CHS", "WKS"), this.getStation(this.S5, "STN", "STR", "HGM", "STV", "PEN", "FD", "NG", "HPG", "BIS", "MDF", "KAD", "WT", "BDF", "FFO", "LI", "NPL", "OKS", "WRS", "OSB", "JB", "ALX", "HKM", "FST", "HBF", "BEV", "TGN", "ZOS", "SAP", "CHS", "WKS"), this.getStation(this.S7, "AF", "MEA", "RW", "MAZ", "POE", "SPH", "FFO", "LI", "NPL", "OKS", "WRS", "OSB", "JB", "ALX", "HKM", "FST", "HBF", "BEV", "TGN", "ZOS", "SAP", "CHS", "WKS"), this.getStation(this.S9, "LI", "NPL", "OKS", "GAS", "FLH", "GBA", "AGL", "ADL", "SCF", "SW", "BMW", "PWA", "TP", "WRS", "OSB", "JB", "ALX", "HKM", "FST", "HBF", "BEV", "TGN", "ZOS", "SAP", "CHS", "WKS"), this.getTerminus("349", "Preußenallee", "Theodor-Heuss-Platz"), this.getTerminus("349", "Grunewald")]]
        },
        BNK: {
        ...
        BNB: {
          ...
          filter: [[this.getStation(this.S1, "ORB", "LEN", "BOR", "BIW", "HN", "FOH", "HED", "WAI", "WIN", "WM", "SNH", "WOK", "BOS", "GB", "HUM"), this.getStation(this.S2, "BER", "BRF", "ZEP", "RGT", "BU", "KRW", "BLB", "PHD", "PKW", "BOS", "GB", "HUM"), this.getStation(this.S25, "HD", "HLS", "SZF", "TG", "EBD", "KBO", "ARF", "SNH", "WOK", "BOS", "GB", "HUM"), this.getStation(this.S26, "WAI", "WIN", "WM", "SNH", "WOK", "BOS", "GB", "HUM"), this.getStation(this.S1, "PDH", "BAB", "GRI", "WSS", "NIW", "SLS", "MEX", "ZD", "SDG", "LWE", "BGT", "RST", "FB", "FRU", "SGV", "JLB", "YOR", "AHU", "POP", "TOR", "FSTT", "ORS"), this.getStation(this.S2, "BFD", "MAH", "LRD", "SC", "BCH", "MF", "ATS", "PRS", "SKV", "YOR", "AHU", "POP", "TOR", "FSTT", "ORS"), this.getStation(this.S25, "TLS", "LIS", "OSS", "LIO", "LAK", "SDE", "PRS", "SKV", "YOR", "AHU", "POP", "TOR", "FSTT", "ORS"), this.getStation(this.S26, "TLS", "LIS", "OSS", "LIO", "LAK", "SDE", "PRS", "SKV", "YOR", "AHU", "POP", "TOR", "FSTT", "ORS"), this.getTerminus("M8", "Hauptbahnhof"), this.getTerminus("M10", "Hauptbahnhof"), this.getTerminus("12", "Am Kupfergraben"), this.getTerminus("M8", "Ahrensfelde/Stadtgrenze", "Betriebshof", "Marzahn"), this.getTerminus("M10", "Warschauer Str"), this.getTerminus("12", "Pasedagplatz"), this.getTerminus("N40", "Turmstr"), this.getTerminus("247", "Leopoldplatz")], [this.getTerminus("247", "Leopoldplatz")]]
        },
        BOLS: {
          stop: [900000025321, 900000025301],
          filter: [[this.getStation(this.S3, "SPA", "SRW", "PIC"), this.getStation(this.S9, "SPA", "SRW", "PIC"), this.getStation(this.S3, "E", "WIG", "RD", "FRH", "HIG", "KPK", "WHH", "KLH", "RB", "RH", "OKS", "WRS", "OSB", "JB", "ALX", "HKM", "FST", "HBF", "BEV", "TGN", "ZOS", "SAP", "CHS", "WKS", "MS", "HST"), this.getStation(this.S5, "NULL"), this.getStation(this.S7, "NULL"), this.getStation(this.S9, "LI", "NPL", "OKS", "GAS", "FLH", "GBA", "AGL", "ADL", "SCF", "SW", "BMW", "PWA", "TP", "WRS", "OSB", "JB", "ALX", "HKM", "FST", "HBF", "BEV", "TGN", "ZOS", "SAP", "CHS", "WKS", "MS", "HST")], [this.getTerminus("M49", "Nennhauser Damm", "Reimerweg", "Gatower Str"), this.getTerminus("218", "Pfaueninsel"), this.getTerminus("M49", "Zoologischer Garten", "Savignyplatz", "Wilmersdorfer Str", "Haus des Rundfunks"), this.getTerminus("218", "Messe Nord/ICC")]]
        },
        BORS: {
          stop: [900000100007],
          filter: [[this.getStation(this.S1, "ORB", "LEN", "BOR", "BIW", "HN", "FOH", "HED", "WAI", "WIN", "WM", "SNH", "WOK", "BOS", "GB", "HUM", "NB"), this.getStation(this.S2, "BER", "BRF", "ZEP", "RGT", "BU", "KRW", "BLB", "PHD", "PKW", "BOS", "GB", "HUM", "NB"), this.getStation(this.S25, "HD", "HLS", "SZF", "TG", "EBD", "KBO", "ARF", "SNH", "WOK", "BOS", "GB", "HUM", "NB"), this.getStation(this.S26, "WAI", "WIN", "WM", "SNH", "WOK", "BOS", "GB", "HUM", "NB"), this.getStation(this.S1, "PDH", "BAB", "GRI", "WSS", "NIW", "SLS", "MEX", "ZD", "SDG", "LWE", "BGT", "RST", "FB", "FRU", "SGV", "JLB", "YOR", "AHU", "POP", "TOR", "FSTT"), this.getStation(this.S2, "BFD", "MAH", "LRD", "SC", "BCH", "MF", "ATS", "PRS", "SKV", "YOR", "AHU", "POP", "TOR", "FSTT"), this.getStation(this.S25, "TLS", "LIS", "OSS", "LIO", "LAK", "SDE", "PRS", "SKV", "YOR", "AHU", "POP", "TOR", "FSTT"), this.getStation(this.S26, "TLS", "LIS", "OSS", "LIO", "LAK", "SDE", "PRS", "SKV", "YOR", "AHU", "POP", "TOR", "FSTT"), this.getTerminus("M1", "Am Kupfergraben"), this.getTerminus("M5", "Hauptbahnhof"), this.getTerminus("M8", "Hauptbahnhof"), this.getTerminus("M1", "Schillerstr", "Rosenthal Nord"), this.getTerminus("M5", "Zingster Str"), this.getTerminus("M8", "Ahrensfelde/Stadtgrenze", "Betriebshof", "Marzahn")]]
        },
        BOSB: {
          stop: [900000120005],
        ...
        BPIC: {
          ...
          filter: [[this.getStation(this.S3, "SPA", "SRW"), this.getStation(this.S9, "SPA", "SRW"), this.getStation(this.S3, "E", "WIG", "RD", "FRH", "HIG", "KPK", "WHH", "KLH", "RB", "RH", "OKS", "WRS", "OSB", "JB", "ALX", "HKM", "FST", "HBF", "BEV", "TGN", "ZOS", "SAP", "CHS", "WKS", "MS", "HST", "OLS"), this.getStation(this.S9, "LI", "NPL", "OKS", "GAS", "FLH", "GBA", "AGL", "ADL", "SCF", "SW", "BMW", "PWA", "TP", "WRS", "OSB", "JB", "ALX", "HKM", "FST", "HBF", "BEV", "TGN", "ZOS", "SAP", "CHS", "WKS", "MS", "HST", "OLS")], [this.getTerminus("M49", "Nennhauser Damm", "Reimerweg", "Gatower Str"), this.getTerminus("218", "Pfaueninsel"), this.getTerminus("M49", "Zoologischer Garten", "Savignyplatz", "Wilmersdorfer Str", "Haus des Rundfunks"), this.getTerminus("218", "Messe Nord/ICC")]]
        },
        BPWA: {
        ...
        BSAP: {
          stop: [900000024203],
          filter: [[this.getStation(this.S3, "GWD", "SPA", "SRW", "PIC", "OLS", "HST", "MS", "WKS", "CHS"), this.getStation(this.S5, "GWD", "OLS", "HST", "MS", "WKS", "CHS"), this.getStation(this.S7, "OLS", "HST", "MS", "PDH", "BAB", "GRI", "WSS", "NIS", "GWD", "WKS", "CHS"), this.getStation(this.S9, "GWD", "SPA", "SRW", "PIC", "OLS", "HST", "MS", "WKS", "CHS"), this.getStation(this.S3, "E", "WIG", "RD", "FRH", "HIG", "KPK", "WHH", "KLH", "RB", "RH", "OKS", "WRS", "OSB", "JB", "ALX", "HKM", "FST", "HBF", "BEV", "TGN", "ZOS"), this.getStation(this.S5, "STN", "STR", "HGM", "STV", "PEN", "FD", "NG", "HPG", "BIS", "MDF", "KAD", "WT", "BDF", "FFO", "LI", "NPL", "OKS", "WRS", "OSB", "JB", "ALX", "HKM", "FST", "HBF", "BEV", "TGN", "ZOS"), this.getStation(this.S7, "AF", "MEA", "RW", "MAZ", "POE", "SPH", "FFO", "LI", "NPL", "OKS", "WRS", "OSB", "JB", "ALX", "HKM", "FST", "HBF", "BEV", "TGN", "ZOS"), this.getStation(this.S9, "LI", "NPL", "OKS", "GAS", "FLH", "GBA", "AGL", "ADL", "SCF", "SW", "BMW", "PWA", "TP", "WRS", "OSB", "JB", "ALX", "HKM", "FST", "HBF", "BEV", "TGN", "ZOS")]]
        },
        BSG: {
          stop: [900000054104],
        ...
        BSPA: {
          ...
          filter: [[this.getTerminus("RE2", "Wismar", "Bad Kleinen", "Schwerin", "Wittenberge"), this.getTerminus("RE4", "Stendal", "Rathenow"), this.getTerminus("RE6", "Wittenberge", "Neuruppin"), this.getTerminus("RB10", "Nauen"), this.getTerminus("RB13", "Wustermark"), this.getTerminus("RB14", "Nauen"), this.getTerminus("RE2", "Cottbus"), this.getTerminus("RE4", "Jüterbog", "Luckenwalde", "Ludwigsfelde"), this.getTerminus("RE6", "Gesundbrunnen"), this.getTerminus("RB10", "Südkreuz"), this.getTerminus("RB13", "Jungfernheide"), this.getTerminus("RB14", "Schönefeld"), this.getStation(this.S3, "NULL"), this.getStation(this.S9, "NULL")], [this.getStation(this.U7, "NULL"), this.getTerminus("M37", "Waldkrankenhaus", "Im Spektefeld"), this.getTerminus("M45", "Johannesstift"), this.getTerminus("X33", "Wilhelmsruher Damm"), this.getTerminus("X36", "Haselhorst"), this.getTerminus("134", "Wasserwerk Spandau", "In den Kisseln"), this.getTerminus("136", "Hennigsdorf", "Aalemannufer", "Werderstr"), this.getTerminus("137", "Freudstr"), this.getTerminus("236", "Haselhorst"), this.getTerminus("337", "Falkensee"), this.getTerminus("671", "Nauen", "Paaren"), this.getTerminus("N7", "Schönefeld", "Rudow"), this.getTerminus("N34", "Aalemannufer"), this.getTerminus("M32", "Havelpark", "Heidebergplan", "Brunsbütteler Damm", "Döberitzer Weg"), this.getTerminus("M37", "Hahneberg", "Reimerweg"), this.getTerminus("M45", "Zoologischer Garten"), this.getTerminus("134", "Hottengrund", "Alt-Kladow", "Alt-Gatow", "Gatower Str", "Am Omnibushof"), this.getTerminus("135", "Hottengrund", "Alt-Kladow", "Landstadt Gatow", "Am Omnibushof"), this.getTerminus("136", "Gatower Str"), this.getTerminus("137", "Reimerweg"), this.getTerminus("236", "Gatower Str"), this.getTerminus("638", "Potsdam", "Campus Jungfernsee"), this.getTerminus("N34", "Hottengrund")], [this.getTerminus("130", "Waldkrankenhaus", "Westerwaldstr"), this.getTerminus("237", "Isenburger Str"), this.getTerminus("N30", "Westerwaldstr"), this.getTerminus("X33", "Wilhelmsruher Damm"), this.getTerminus("X36", "Haselhorst"), this.getTerminus("130", "Ruhleben", "Stresow"), this.getTerminus("337", "Falkensee"), this.getTerminus("671", "Nauen", "Paaren"), this.getTerminus("N7", "Schönefeld", "Rudow")]]
        },
        BSTO: {
        ...
        BSRW: {
          ...
          filter: [[this.getStation(this.S3, "SPA"), this.getStation(this.S9, "SPA"), this.getStation(this.S3, "E", "WIG", "RD", "FRH", "HIG", "KPK", "WHH", "KLH", "RB", "RH", "OKS", "WRS", "OSB", "JB", "ALX", "HKM", "FST", "HBF", "BEV", "TGN", "ZOS", "SAP", "CHS", "WKS", "MS", "HST", "OLS", "PIC"), this.getStation(this.S9, "LI", "NPL", "OKS", "GAS", "FLH", "GBA", "AGL", "ADL", "SCF", "SW", "BMW", "PWA", "TP", "WRS", "OSB", "JB", "ALX", "HKM", "FST", "HBF", "BEV", "TGN", "ZOS", "SAP", "CHS", "WKS", "MS", "HST", "OLS", "PIC")], [this.getTerminus("130", "Waldkrankenhaus", "Westerwaldstr", "Rathaus Spandau"), this.getTerminus("130", "Ruhleben")]]
        },
        BSK: {
        ...
        BZOS: {
          stop: [900000023201, 900000023172],
          filter: [[this.getTerminus("RE1", "Magdeburg", "Brandenburg", "Potsdam"), this.getTerminus("RE2", "Wismar", "Bad Kleinen", "Schwerin", "Wittenberge"), this.getTerminus("RE7", "Dessau", "Bad Belzig"), this.getTerminus("RB14", "Nauen"), this.getTerminus("RB21", "Wustermark", "Golm", "Potsdam"), this.getTerminus("RB22", "Königs Wusterhausen", "Schönefeld", "Golm", "Potsdam"), this.getTerminus("RE1", "Cottbus", "Eisenhüttenstadt", "Frankfurt"), this.getTerminus("RE2", "Cottbus"), this.getTerminus("RE7", "Wünsdorf-Waldstadt", "Schönefeld"), this.getTerminus("RB14", "Schönefeld"), this.getTerminus("RB21", "Friedrichstr"), this.getTerminus("RB22", "Friedrichstr"), this.getStation(this.S3, "GWD", "SPA", "SRW", "PIC", "OLS", "HST", "MS", "WKS", "CHS", "SAP"), this.getStation(this.S5, "GWD", "OLS", "HST", "MS", "WKS", "CHS", "SAP"), this.getStation(this.S7, "OLS", "HST", "MS", "PDH", "BAB", "GRI", "WSS", "NIS", "GWD", "WKS", "CHS", "SAP"), this.getStation(this.S9, "GWD", "SPA", "SRW", "PIC", "OLS", "HST", "MS", "WKS", "CHS", "SAP"), this.getStation(this.S3, "E", "WIG", "RD", "FRH", "HIG", "KPK", "WHH", "KLH", "RB", "RH", "OKS", "WRS", "OSB", "JB", "ALX", "HKM", "FST", "HBF", "BEV", "TGN"), this.getStation(this.S5, "STN", "STR", "HGM", "STV", "PEN", "FD", "NG", "HPG", "BIS", "MDF", "KAD", "WT", "BDF", "FFO", "LI", "NPL", "OKS", "WRS", "OSB", "JB", "ALX", "HKM", "FST", "HBF", "BEV", "TGN"), this.getStation(this.S7, "AF", "MEA", "RW", "MAZ", "POE", "SPH", "FFO", "LI", "NPL", "OKS", "WRS", "OSB", "JB", "ALX", "HKM", "FST", "HBF", "BEV", "TGN"), this.getStation(this.S9, "LI", "NPL", "OKS", "GAS", "FLH", "GBA", "AGL", "ADL", "SCF", "SW", "BMW", "PWA", "TP", "WRS", "OSB", "JB", "ALX", "HKM", "FST", "HBF", "BEV", "TGN"), this.getStation(this.U2, "Rl", "Sd", "Nd", "Th", "Kd", "So", "Bmo", "Obi", "RP"), this.getStation(this.U2, "PA", "VIN", "Sh", "EB", "Sz", "Lu", "A", "Ko", "Mk", "Sp", "Hv", "Mi", "MH", "Pd", "MB", "Gu", "BS", "No", "Wt"), this.getStation(this.U9, "Olo", "Np", "Lpu", "Am", "WF", "Bi", "Tm", "Ha"), this.getStation(this.U9, "Rzu", "Sl", "Wsg", "Fw", "Bd", "Beo", "Gt", "Snu", "Kfu"), this.getTerminus("M45", "Johannesstift", "Rathaus Spandau", "DRK-Kliniken Westend"), this.getTerminus("M46", "Britz-Süd", "Alt-Tempelhof", "Südkreuz"), this.getTerminus("M49", "Nennhauser Damm", "Reimerweg", "Gatower Str"), this.getTerminus("X9", "Flughafen Tegel"), this.getTerminus("X10", "Teltow", "Andr&#233;ezeile"), this.getTerminus("X34", "Hottengrund", "Gutsstr", "Alt-Kladow", "Gatower Str"), this.getTerminus("100", "Alexanderplatz"), this.getTerminus("109", "Flughafen Tegel", "Airport Tegel"), this.getTerminus("110", "Oskar-Helene-Heim"), this.getTerminus("200", "Michelangelostr", "Alexanderplatz", "Unter den Linden/Friedrichstr"), this.getTerminus("204", "Südkreuz"), this.getTerminus("245", "Hauptbahnhof", "Turmstr", "Franklinstr"), this.getTerminus("249", "Roseneck"), this.getTerminus("N1", "Warschauer Str"), this.getTerminus("N2", "Pankow", "Hackescher Markt", "Alexanderplatz"), this.getTerminus("N9", "Rathaus Steglitz"), this.getTerminus("N10", "Sachtlebenstr"), this.getTerminus("N26", "Seestr"), this.getTerminus("M45", "Hertzallee"), this.getTerminus("M46", "Hertzallee"), this.getTerminus("M49", "Hertzallee"), this.getTerminus("X9", "Hertzallee"), this.getTerminus("X10", "Hertzallee"), this.getTerminus("X34", "Hertzallee"), this.getTerminus("109", "Hertzallee"), this.getTerminus("110", "Hertzallee"), this.getTerminus("204", "Hertzallee"), this.getTerminus("245", "Hertzallee"), this.getTerminus("249", "Hertzallee"), this.getTerminus("N10", "Hertzallee"), this.getTerminus("N26", "Hertzallee")], [this.getTerminus("M45", "Johannesstift", "Rathaus Spandau", "DRK-Kliniken Westend"), this.getTerminus("245", "Hauptbahnhof", "Turmstr", "Franklinstr"), this.getTerminus("N2", "Ruhleben"), this.getTerminus("N9", "Osloer Str")]]
        },
        jov: {
          stop: [900000160541],
