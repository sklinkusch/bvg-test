class Station {
    ...
    dropdown.addEventListener("input", e => {
      ...
      switch (selectValue) {
        ...
        case "BJB":
          ...
          this.filter = [[this.getStation(this.S3,'GWD','SPA','SRW','PIC','OLS','HST','MS','WKS','CHS','SAP','ZOS','TGN','BEV','HBF','FST','HKM','ALX'), this.getStation(this.S5,'GWD','OLS','HST','MS','WKS','CHS','SAP','ZOS','TGN','BEV','HBF','FST','HKM','ALX'), this.getStation(this.S7,'OLS','HST','MS','PDH','BAB','GRI','WSS','NIS','GWD','WKS','CHS','SAP','ZOS','TGN','BEV','HBF','FST','HKM','ALX'), this.getStation(this.S9,'GWD','SPA','SRW','PIC','OLS','HST','MS','WKS','CHS','SAP','ZOS','TGN','BEV','HBF','FST','HKM','ALX'), this.getStation(this.S3,'E','WIG','RD','FRH','HIG','KPK','WHH','KLH','RB','RH','OKS','WRS','OSB'), this.getStation(this.S5,'STN','STR','HGM','STV','PEN','FD','NG','HPG','BIS','MDF','KAD','WT','BDF','FFO','LI','NPL','OKS','WRS','OSB'), this.getStation(this.S7,'AF','MEA','RW','MAZ','POE','SPH','FFO','LI','NPL','OKS','WRS','OSB'), this.getStation(this.S9,'LI','NPL','OKS','GAS','FLH','GBA','AGL','ADL','SCF','SW','BMW','PWA','TP','WRS','OSB'), this.getStation(this.U8,'WIU','RR','KB','LD','PB','RE','FN','Olu','Pk','Gb','Vo','B','Ro','W','Ap'), this.getStation(this.U8,'HMS','L','Bo','Hpo','ST','Kbu','Mr','He'), [{line: "248", dir: "Breitenbachplatz"}, {line: "248", dir: "Südkreuz"}, {line: "248", dir: "Hallesches Tor"}, {line: "248", dir: "Alexanderplatz"}], [{line: "N40", dir: "Turmstr"}], [{line: "248", dir: "Warschauer Str"}, {line: "248", dir: "Ostbahnhof"}], [{line: "N40", dir: "Wühlischplatz"}], [{line: "N8", dir: "Wilhelmsruher Damm"}, {line: "N8", dir: "Osloer Str"}], [{line: "N65", dir: "Hackescher Markt"}], [{line: "N8", dir: "Hermannstr"}, {line: "N8", dir: "Hermannplatz"}], [{line: "N65", dir: "Müggelschlößchenweg"}, {line: "N65", dir: "Schöneweide"}]]];
          break;
        case "BJUN":
          this.stop = [900000020201, 900000020207];
          this.filter = [[[{ line: "RE4", dir: "Stendal" }, { line: "RE4", dir: "Rathenow" }], [{ line: "RE6", dir: "Wittenberge" }, { line: "RE6", dir: "Neuruppin" }], [{ line: "RB10", dir: "Nauen" }], [{ line: "RB13", dir: "Wustermark" }], [{ line: "RE4", dir: "Jüterbog" }, { line: "RE4", dir: "Luckenwalde" }, { line: "RE4", dir: "Ludwigsfelde" }], [{ line: "RE6", dir: "Gesundbrunnen" }], [{ line: "RB10", dir: "Südkreuz" }], [this.S41], this.getStation(this.S46,'GB','WED','WH','BEU'), [this.S42], this.getStation(this.S46,'KW','WI','ZTH','EIW','GAS','ADL','SCF','SW','BMW','KHD','NK','HER','THF','SKR','SGR','IP','BUP','HEI','HO','HAL','WKRR','MN','WES'), this.getStation(this.U7,'R','Zd','Wk','La','Jt','Br','Pi','Bl','Gz','Nk','KM','Rk','Hpu','Sü','Gs','Me','Mu','Y','Kt','Ei','Bpu','Beu','Bli','Ad','Wd','Bmu','Rw','Mp'), this.getStation(this.U7,'RSp','AS','Zi','Hs','P','Rm','Sie','Hl','JK'), [{ line: "M21", dir: "Uhlandstr" }], [{ line: "M21", dir: "Goerdelersteg" }], [{ line: "M27", dir: "Pankow" }], [{ line: "X9", dir: "Zoologischer Garten" }], [{ line: "N7", dir: "Schönefeld" }], [{ line: "M27", dir: "Jungfernheide" }], [{ line: "N7", dir: "Rathaus Spandau" }]], [[{ line: "M27", dir: "Jungfernheide" }], [{ line: "X9", dir: "Flughafen Tegel" }], [{ line: "109", dir: "Flughafen Tegel" }], [{ line: "N7", dir: "Rathaus Spandau" }], [{ line: "109", dir: "Zoologischer Garten" }]]];
          break;
        case "BLST":
          this.stop = [900000110004];
          this.filter = [[[this.S41], this.getStation(this.S8,'ZTH','EIW','GAS','ADL','SCF','SW','BMW','PWA','TP','OK','FA','STO'), this.getStation(this.S85,'GAS','ADL','SCF','SW','BMW','PWA','TP','OK','FA','STO'), [this.S42], this.getStation(this.S8,'BIW','HN','BFE','SNF','MM','BLB','PHD','PKW','BOS','SAL','PLA','GSS'), this.getStation(this.S85,'NB','HUM','GB','PKW','BOS','SAL','PLA','GSS'), [{ line: "M5", dir: "Hauptbahnhof" }, { line: "M5", dir: "Hackescher Markt" }, { line: "M5", dir: "Landsberger Allee/Petersburger Str" }], [{ line: "M6", dir: "Hackescher Markt" }, { line: "M6", dir: "Landsberger Allee/Petersburger Str" }], [{ line: "M8", dir: "Hauptbahnhof" }, { line: "M8", dir: "Landsberger Allee/Petersburger Str" }], [{ line: "M5", dir: "Zingster Str" }], [{ line: "M6", dir: "Riesaer Str" }, { line: "M6", dir: "Betriebshof Marzahn" }, { line: "M6", dir: "S Marzahn" }], [{ line: "M8", dir: "Ahrensfelde/Stadtgrenze" }, { line: "M8", dir: "Betriebshof Marzahn" }], [{ line: "156", dir: "Stadion Buschallee/Hansastr" }, { line: "156", dir: "Große Seestr." }, { line: "156", dir: "Pasedagplatz" }],[{line: "156", dir: "Storkower Str"}]]];
          break;
        case "BMN":
          this.stop = [900000024106,900000026204,900000026202];
          this.filter = [[[this.S41], this.getStation(this.S46,'GB','WED','WH','BEU','JUN','WES'), [this.S42], this.getStation(this.S46,'KW','WI','ZTH','EIW','GAS','ADL','SCF','SW','BMW','KHD','NK','HER','THF','SKR','SGR','IP','BUP','HEI','HO','HAL','WKRR'), [{ line: "M49", dir: "Nennhauser Damm" }, { line: "M49", dir: "Reimerweg" }, { line: "M49", dir: "Gatower Str" }], [{ line: "X34", dir: "Hottengrund" }, { line: "X34", dir: "Gutsstr" }, { line: "X34", dir: "Gatower Str" }], [{ line: "X49", dir: "Hahneberg" }, { line: "X49", dir: "Spektefeld" }, { line: "X49", dir: "Gatower Str" }], [{ line: "139", dir: "Werderstr" }], [{ line: "218", dir: "Pfaueninsel" }], [{ line: "M49", dir: "Zoologischer Garten" }, { line: "M49", dir: "Savignyplatz" }, { line: "M49", dir: "Wilmersdorfer Str" }], [{ line: "X34", dir: "Zoologischer Garten" }, { line: "X34", dir: "Savignyplatz" }, { line: "X34", dir: "Wilmersdorfer" }], [{ line: "X49", dir: "Wilmersdorfer" }]],[[{line: "139", dir: "Werderstr"}],[{line: "139", dir: "Messe Nord/ICC"}]],[this.getStation(this.U2,'Rl','Sd','Nd','Th'),this.getStation(this.U2,'PA','VIN','Sh','EB','Sz','Lu','A','Ko','Mk','Sp','Hv','Mi','MH','Pd','MB','Gu','BS','No','Wt','Zo','RP','Obi','Bmo','So'), [{line: "139", dir: "Werderstr"}], [{line: "139", dir: "Messe Nord/ICC"}], [{line: "N2", dir: "Ruhleben"}], [{line: "N2", dir: "Pankow"}, {line: "N2", dir: "Hackescher Markt"}, {line: "N2", dir: "Zoologischer Garten"}]]];
          break;
        case "BNK":
          this.stop = [900000078201, 900000078272, 900000078273, 900000078271];
          this.filter = [[[this.S41], this.getStation(this.S45,'SKR','THF','HER'), this.getStation(this.S46,'GB','WED','WH','BEU','JUN','WES','MN','WKRR','HAL','HO','HEI','BUP','IP','SGR','SKR','THF','HER'), [this.S47.HER], [this.S42], this.getStation(this.S45,'GAS','FLH','GBA','AGL','ADL','SCF','SW','BMW','KHD'), this.getStation(this.S46,'KW','WI','ZTH','EIW','GAS','ADL','SCF','SW','BMW','KHD'), this.getStation(this.S47,'SPF','OSP','SW','BMW','KHD')], [this.getStation(this.U7,'R','Zd','Wk','La','Jt','Br','Pi','Bl','Gz'), this.getStation(this.U7,'RSp','AS','Zi','Hs','P','Rm','Sie','Hl','JK','Jh','Mp','Rw','Bmu','Wd','Ad','Kn','Fpu','Bli','Beu','Bpu','Ei','Kt','Y','Mu','Me','Gs','Sü','Hpu','Rk','KM')], [[{ line: "171", dir: "Schönefeld" }, { line: "171", dir: "Rudow" }], [{ line: "N7", dir: "Schönefeld" }], [{ line: "N79", dir: "Alt-Mariendorf" }], [{ line: "171", dir: "Hermannplatz" }, { line: "171", dir: "Sonnenallee" }], [{ line: "N7", dir: "Rathaus Spandau" }], [{ line: "N79", dir: "Plänterwald" }]], [[{ line: "171", dir: "Schönefeld" }, { line: "171", dir: "Rudow" }], [{ line: "N7", dir: "Schönefeld" }], [{ line: "370", dir: "Neuköllnische Brücke" }], [{ line: "377", dir: "Plänterwald" }], [{ line: "171", dir: "Hermannplatz" }, { line: "171", dir: "Sonnenallee" }], [{ line: "N7", dir: "Rathaus Spandau" }], [{ line: "370", dir: "Hermannstr" }], [{ line: "377", dir: "Hermannstr" }]]];
          break;
        case "BOSB":
          this.stop = [900000120005];
          this.filter = [[[{line: "RE1", dir: "Magdeburg"}, {line: "RE1", dir: "Brandenburg"}, {line: "Potsdam"}], [{line: "RE2", dir: "Wismar"}, {line: "RE2", dir: "Bad Kleinen"}, {line: "RE2", dir: "Schwerin"}, {line: "RE2", dir: "Wittenberge"}], [{line: "RE7", dir: "Dessau"}, {line: "RE7", dir: "Bad Belzig"}], [{line: "RB14", dir: "Nauen"}], [{line: "RE1", dir: "Cottbus"}, {line: "RE1", dir: "Eisenhüttenstadt"}, {line: "RE1", dir: "Frankfurt"}], [{line: "RE2", dir: "Cottbus"}], [{line: "RE7", dir: "Wünsdorf-Waldstadt"}, {line: "RE7", dir: "Schönefeld"}], [{line: "RB14", dir: "Schönefeld"}], this.getStation(this.S3, 'GWD', 'SPA', 'SRW', 'PIC', 'OLS', 'HST', 'MS', 'WKS', 'CHS', 'SAP', 'ZOS', 'TGN', 'BEV', 'HBF', 'FST', 'HKM', 'ALX', 'JB'), this.getStation(this.S5, 'GWD', 'OLS', 'HST', 'MS', 'WKS', 'CHS', 'SAP', 'ZOS', 'TGN', 'BEV', 'HBF', 'FST', 'HKM', 'ALX', 'JB'), this.getStation(this.S7, 'OLS', 'HST', 'MS', 'PDH', 'BAB', 'GRI', 'WSS', 'NIS', 'GWD', 'WKS', 'CHS', 'SAP', 'ZOS', 'TGN', 'BEV', 'HBF', 'FST', 'HKM', 'ALX', 'JB'), this.getStation(this.S9, 'GWD', 'SPA', 'SRW', 'PIC', 'OLS', 'HST', 'MS', 'WKS', 'CHS', 'SAP', 'ZOS', 'TGN', 'BEV', 'HBF', 'FST', 'HKM', 'ALX', 'JB'), this.getStation(this.S3, 'E', 'WIG', 'RD', 'FRH', 'HIG', 'KPK', 'WHH', 'KLH', 'RB', 'RH', 'OKS', 'WRS'), this.getStation(this.S5, 'STN', 'STR', 'HGM', 'STV', 'PEN', 'FD', 'NG', 'HPG', 'BIS', 'MDF', 'KAD', 'WT', 'BDF', 'FFO', 'LI', 'NPL', 'OKS', 'WRS'), this.getStation(this.S7, 'AF', 'MEA', 'RW', 'MAZ', 'POE', 'SPH', 'FFO', 'LI', 'NPL', 'OKS', 'WRS'), [this.S75.NULL], this.getStation(this.S9, 'LI', 'NPL', 'OKS', 'GAS', 'FLH', 'GBA', 'AGL', 'ADL', 'SCF', 'SW', 'BMW', 'PWA', 'TP', 'WRS'), [{line: "142", dir: "Leopoldplatz"}, {line: "142", dir: "Hauptbahnhof"}], [{line: "248", dir: "Breitenbachplatz"}, {line: "248", dir: "Südkreuz"}, {line: "248", dir: "Hallesches Tor"}, {line: "248", dir: "Alexanderplatz"}], [{line: "N40", dir: "Turmstr"}], [{line: "147", dir: "Hauptbahnhof"}, {line: "147", dir: "Unter den Linden/Friedrichstr"}, {line: "147", dir: "Märkisches Museum"}], [{line: "240", dir: "Storkower Str"}, {line: "240", dir: "Betriebshof Lichtenberg"}], [{line: "248", dir: "Warschauer Str"}], [{line: "347", dir: "Tunnelstr"}, {line: "347", dir: "Warschauer Str"}], [{line: "N40", dir: "Wühlischplatz"}]]];
          break;
        case "BOK":
          this.stop = [900000120003];
          this.filter = [[[{ line: "RE1", dir: "Cottbus" }, { line: "RE1", dir: "Eisenhüttenstadt" }, { line: "RE1", dir: "Frankfurt" }], [{ line: "RE2", dir: "Cottbus" }], [{ line: "RE7", dir: "Wünsdorf-Waldstadt" }, { line: "RE7", dir: "Schönefeld" }], [{ line: "RB12", dir: "Templin" }], [{ line: "RB14", dir: "Schönefeld" }], [{ line: "RB24", dir: "Eberswalde" }], [{ line: "RB25", dir: "Werneuchen" }], [{ line: "RB26", dir: "Gorz&#243;w" }, { line: "RB26", dir: "Kostrzyn" }], [{ line: "RE1", dir: "Magdeburg" }, { line: "RE1", dir: "Brandenburg" }, { line: "RE1", dir: "Potsdam" }], [{ line: "RE2", dir: "Wismar" }, { line: "RE2", dir: "Bad Kleinen" }, { line: "RE2", dir: "Schwerin" }, { line: "RE2", dir: "Wittenberge" }], [{ line: "RE7", dir: "Dessau" }, { line: "RE7", dir: "Bad Belzig" }], [{ line: "RB14", dir: "Nauen" }], [{ line: "RB24", dir: "Senftenberg" }, { line: "RB24", dir: "Cottbus" }], this.getStation(this.S3, 'GWD', 'SPA', 'SRW', 'PIC', 'OLS', 'HST', 'MS', 'WKS', 'CHS', 'SAP', 'ZOS', 'TGN', 'BEV', 'HBF', 'FST', 'HKM', 'ALX', 'JB', 'OSB', 'WRS'), this.getStation(this.S5, 'GWD', 'OLS', 'HST', 'MS', 'WKS', 'CHS', 'SAP', 'ZOS', 'TGN', 'BEV', 'HBF', 'FST', 'HKM', 'ALX', 'JB', 'OSB', 'WRS'), this.getStation(this.S7, 'OLS', 'HST', 'MS', 'PDH', 'BAB', 'GRI', 'WSS', 'NIS', 'GWD', 'WKS', 'CHS', 'SAP', 'ZOS', 'TGN', 'BEV', 'HBF', 'FST', 'HKM', 'ALX', 'JB', 'OSB', 'WRS'), this.getStation(this.S75, 'OSB', 'WRS'), this.getStation(this.S9, 'GWD', 'SPA','SRW', 'PIC', 'OLS', 'HST', 'MS', 'WKS', 'CHS', 'SAP', 'ZOS', 'TGN', 'BEV', 'HBF', 'FST', 'HKM', 'ALX', 'JB', 'OSB', 'WRS'), this.getStation(this.S3, 'E', 'WIG', 'RD', 'FRH', 'HIG', 'KPK', 'WHH', 'KLH', 'RB', 'RH'), this.getStation(this.S5, 'STN', 'STR', 'HGM', 'STV', 'PEN', 'FD', 'NG', 'HPG', 'BIS', 'MDF', 'KAD', 'WT', 'BDF', 'FFO', 'LI', 'NPL'), this.getStation(this.S7, 'AF', 'MEA', 'RW', 'MAZ', 'POE', 'SPH', 'FFO', 'LI', 'NPL'), this.getStation(this.S75, 'WAB', 'HH', 'GSE', 'SPH', 'FFO', 'LI', 'NPL'), this.getStation(this.S9, 'LI', 'NPL'), [this.S41], this.getStation(this.S8, 'ZTH', 'EIW', 'GAS', 'ADL', 'SCF', 'SW', 'BMW', 'PWA', 'TP'), this.getStation(this.S85, 'GAS','ADL', 'SCF', 'SW', 'BMW', 'PWA', 'TP'), [this.S42], this.getStation(this.S8, 'BIW', 'HN', 'BFE', 'SNF', 'MM', 'BLB', 'PHD', 'PKW', 'BOS', 'SAL', 'PLA', 'GSS', 'LST', 'STO', 'FA'), this.getStation(this.S85, 'NB', 'HUM', 'GB', 'PKW', 'BOS', 'SAL', 'PLA', 'GSS', 'LST', 'STO', 'FA'), [{ line: "194", dir: "Helene-Weigel-Platz" }, { line: "194", dir: "Friedrichsfelde Ost" }, { line: "194", dir: "Nöldnerplatz" }], [{ line: "347", dir: "Tunnelstr" }], [{ line: "N94", dir: "Magdalenenstr" }], [{ line: "194", dir: "Hermannplatz" }, { line: "194", dir: "Treptower Park" }], [{ line: "347", dir: "Ostbahnhof" }, { line: "347", dir: "Warschauer Str" }], [{ line: "N94", dir: "Hermannplatz" }]]];
          break;
        case "BPWA":
          this.stop = [900000191002, 900000191802];
          this.filter = [[[this.S45.TP],[this.S46.TP],[this.S47.TP], this.getStation(this.S8, 'BIW', 'HN', 'BFE', 'SNF', 'MM', 'BLB', 'PHD', 'PKW', 'BOS', 'SAL', 'PLA', 'GSS', 'LST', 'STO', 'FA', 'OK', 'TP'), this.getStation(this.S85, 'NB', 'HUM', 'GB', 'PKW', 'BOS', 'SAL', 'PLA', 'GSS', 'LST', 'STO', 'FA'), this.getStation(this.S9, 'GWD', 'SPA','SRW', 'PIC', 'OLS', 'HST', 'MS', 'WKS', 'CHS', 'SAP', 'ZOS', 'TGN', 'BEV', 'HBF', 'FST', 'HKM', 'ALX', 'JB', 'OSB', 'WRS', 'TP'), this.getStation(this.S45, 'GAS', 'FLH', 'GBA', 'AGL', 'ADL', 'SCF', 'SW', 'BMW'), this.getStation(this.S46, 'KW', 'WI', 'ZTH', 'EIW', 'GAS', 'ADL', 'SCF', 'SW', 'BMW'), this.getStation(this.S47, 'SPF', 'OSP', 'SW', 'BMW'), this.getStation(this.S8, 'ZTH', 'EIW', 'GAS', 'ADL', 'SCF', 'SW', 'BMW'), this.getStation(this.S85, 'GAS', 'ADL', 'SCF', 'SW', 'BMW'), this.getStation(this.S9, 'GAS', 'FLH', 'GBA', 'AGL', 'ADL', 'SCF', 'SW', 'BMW'), [{line: "377", dir: "Hermannstr"}], [{line: "N79", dir: "Alt-Mariendorf"}]], [[{line: "165", dir: "Märkisches Museum"}, {line: "165", dir: "Treptower Park"}], [{line: "166", dir: "Boddinstr"}, {line: "166", dir: "Treptower Park"}], [{line: "N65", dir: "Hackescher Markt"}], [{line: "165", dir: "Schöneweide"}, {line: "165", dir: "Müggelschlößchenweg"}], [{line: "166", dir: "Schöneweide"}], [{line: "377", dir: "Hermannstr"}], [{line: "N65", dir: "Müggelschlößchenweg"}, {line: "N65", dir: "Schöneweide"}], [{line: "N79", dir: "Alt-Mariendorf"}]]];
          break;
        case "BPLA":
          this.stop = [900000110002];
          this.filter = [[[this.S41], this.getStation(this.S8, 'ZTH', 'EIW', 'GAS', 'ADL', 'SCF', 'SW', 'BMW', 'PWA', 'TP', 'OK', 'FA', 'STO', 'LST', 'GSS'), this.getStation(this.S85, 'GAS', 'ADL', 'SCF', 'SW', 'BMW', 'PWA', 'TP', 'OK', 'FA', 'STO', 'LST', 'GSS'), [this.S42], this.getStation(this.S8, 'BIW', 'HN', 'BFE', 'SNF', 'MM', 'BLB', 'PHD', 'PKW', 'BOS', 'SAL'), this.getStation(this.S85, 'NB', 'HUM', 'GB', 'PKW', 'BOS', 'SAL'), [{ line: "M2", dir: "Am Steinberg" }, { line: "M2", dir: "Heinersdorf" }], [{ line: "M2", dir: "Alexanderplatz" }], [{ line: "156", dir: "Stadion Buschallee/Hansastr" }, { line: "156", dir: "Große Seestr" }, { line: "156", dir: "Pasedagplatz" }], [{ line: "156", dir: "Storkower Str" }, { line: "156", dir: "Michelangelostr" }]]];
          break;
        case "BSG":
          this.stop = [900000054104];
          this.filter = [[this.getStation(this.S1, 'ORB', 'LEN', 'BOR', 'BIW', 'HN', 'FOH', 'HED', 'WAI', 'WIN', 'WM', 'SNH', 'WOK', 'BOS', 'GB', 'HUM', 'NB', 'ORS', 'FSTT', 'TOR', 'POP', 'AHU', 'YOR', 'JLB'), this.getStation(this.S1, 'PDH', 'BAB', 'GRI', 'WSS', 'NIW', 'SLS', 'MEX', 'ZD', 'SDG', 'LWE', 'BGT', 'RST', 'FB', 'FRU'), [this.S41], this.getStation(this.S46, 'GB', 'WED', 'WH', 'BEU', 'JUN', 'WES', 'MN', 'WKRR', 'HAL', 'HO', 'HEI', 'BUP', 'IP'), [this.S42], this.getStation(this.S46, 'KW', 'WI', 'ZTH', 'EIW', 'GAS', 'ADL', 'SCF', 'SW', 'BMW', 'KHD', 'NK', 'HER', 'THF', 'SKR'), [{ line: "M46", dir: "Zoologischer Garten" }, { line: "M46", dir: "Wittenbergplatz" }], [{ line: "248", dir: "Breitenbachplatz" }], [{ line: "M46", dir: "Britz-Süd" }, { line: "M46", dir: "Alt-Tempelhof" }, { line: "M46", dir: "Südkreuz" }], [{ line: "248", dir: "Warschauer Str" }, { line: "248", dir: "Ostbahnhof" }, { line: "248", dir: "Alexanderplatz" }, { line: "248", dir: "Hallesches Tor" }, { line: "248", dir: "Südkreuz" }]]];
          break;
        case "BSAL":
          this.stop = [900000110001];
          this.filter = [[[this.S41], this.getStation(this.S8, 'ZTH', 'EIW', 'GAS', 'ADL', 'SCF', 'SW', 'BMW', 'PWA', 'TP', 'OK', 'FA', 'STO', 'LST', 'GSS', 'PLA'), this.getStation(this.S85, 'GAS', 'ADL', 'SCF', 'SW', 'BMW', 'PWA', 'TP', 'OK', 'FA', 'STO', 'LST', 'GSS', 'PLA'), [this.S42], this.getStation(this.S8, 'BIW', 'HN', 'BFE', 'SNF', 'MM', 'BLB', 'PHD', 'PKW', 'BOS'), this.getStation(this.S85, 'NB', 'HUM', 'GB', 'PKW', 'BOS'), this.getStation(this.U2, 'PA', 'VIN'), this.getStation(this.U2, 'Fpo', 'Hz', 'Sno', 'Au', 'Rl', 'Sd', 'Nd', 'Th', 'Kd', 'So', 'Bmo', 'Obi', 'RP', 'Zo', 'Wt', 'No', 'BS', 'Gu', 'MB', 'Pd', 'MH', 'Mi', 'Hv', 'Sp', 'Mk', 'Ko', 'A', 'Lu', 'Sz', 'EB'), [{ line: "M1", dir: "Schillerstr" }, { line: "M1", dir: "Rosenthal Nord" }], [{ line: "M1", dir: "Am Kupfergraben" }, { line: "M1", dir: "Hackescher Markt" }]]];
          break;
        case "BSO":
        ...
        case "BSTO":
          ...
          this.filter = [[[this.S41], this.getStation(this.S8, 'ZTH', 'EIW', 'GAS', 'ADL', 'SCF', 'SW', 'BMW', 'TP', 'OK', 'FA'), this.getStation(this.S85, 'GAS', 'ADL', 'SCF', 'SW', 'BMW', 'TP', 'OK', 'FA'), [this.S42], this.getStation(this.S8, 'BIW', 'HN', 'BFE', 'SNF', 'MM', 'BLB', 'PHD', 'PKW', 'BOS', 'SAL', 'PLA', 'GSS', 'LST'), this.getStation(this.S85, 'NB', 'HUM', 'GB', 'PKW', 'BOS', 'SAL', 'PLA', 'GSS', 'LST'), [{ line: "156", dir: "Stadion Buschallee" }, { line: "156", dir: "Große Seestr" }, { line: "156", dir: "Pasedagplatz" }], [{ line: "240", dir: "Ostbahnhof" }, { line: "240", dir: "Betriebshof Lichtenberg" }]],[[{line: "156", dir: "Stadion Buschallee"}, {line: "156", dir: "Große Seestr"}, {line: "156", dir: "Pasedagplatz"}],[{line: "156", dir: "Storkower Str"}]]];
          break;
        case "BSK":
          this.stop = [900000058101, 900000058100];
          this.filter = [[[{ line: "RE3", dir: "Schwedt" }, { line: "RE3", dir: "Stralsund" }, { line: "RE3", dir: "Prenzlau" }, { line: "RE3", dir: "Angermünde" }, { line: "RE3", dir: "Eberswalde" }], [{ line: "RE4", dir: "Stendal" }, { line: "RE4", dir: "Rathenow" }], [{ line: "RE5", dir: "Rostock" }, { line: "RE5", dir: "Stralsund" }], [{ line: "RB10", dir: "Nauen" }], [{ line: "RE3", dir: "Wittenberg" }, { line: "RE3", dir: "Falkenberg" }, { line: "RE3", dir: "Halle" }], [{ line: "RE4", dir: "Jüterbog" }, { line: "RE4", dir: "Luckenwalde" }, { line: "RE4", dir: "Ludwigsfelde" }], [{ line: "RE5", dir: "Elsterwerda" }, { line: "RE5", dir: "Wünsdorf" }], this.getStation(this.S2, 'BER', 'BRF', 'ZEP', 'RGT', 'BU', 'KRW', 'BLB', 'PHD', 'PKW', 'BOS', 'GB', 'HUM', 'NB', 'ORS', 'FSTT', 'TOR', 'POP', 'AHU', 'YOR'), this.getStation(this.S25, 'HD', 'HLS', 'SZF', 'TG', 'EBD', 'KBO', 'ARF', 'SNH', 'WOK', 'BOS', 'GB', 'HUM', 'NB', 'ORS', 'FSTT', 'TOR', 'POP', 'AHU', 'YOR'), this.getStation(this.S26, 'WAI', 'WIN', 'WM', 'SNH', 'WOK', 'BOS', 'GB', 'HUM', 'NB', 'ORS', 'FSTT', 'TOR', 'POP', 'AHU', 'YOR'), this.getStation(this.S2, 'BFD', 'MAH', 'LRD', 'SC', 'BCH', 'MF', 'ATS', 'PRS'), this.getStation(this.S25, 'TLS', 'LIS', 'OSS', 'LIO', 'LAK', 'SDE', 'PRS'), this.getStation(this.S26, 'TLS', 'LIS', 'OSS', 'LIO', 'LAK', 'SDE', 'PRS'), [this.S41], this.getStation(this.S46, 'GB', 'WED', 'WH', 'BEU', 'JUN', 'WES', 'MN', 'WKRR', 'HAL', 'HO', 'HEI', 'BUP', 'IP', 'SGR'), [this.S42], [this.S45.NULL], this.getStation(this.S46, 'KW', 'WI', 'ZTH', 'EIW', 'GAS', 'ADL', 'SCF', 'SW', 'BMW', 'KHD', 'NK', 'HER', 'THF'), [{ line: "M46", dir: "Zoologischer Garten" }, { line: "M46", dir: "Wittenbergplatz" }], [{ line: "106", dir: "Seestr" }, { line: "106", dir: "Kurfürstenstr" }], [{ line: "204", dir: "Zoologischer Garten" }], [{ line: "M46", dir: "Britz-Süd" }, { line: "M46", dir: "Alt-Tempelhof" }], [{ line: "106", dir: "Lindenhof" }],], [[{ line: "184", dir: "Reichartstr" }], [{ line: "248", dir: "Breitenbachplatz" }], [{ line: "184", dir: "Warthestr" }, { line: "184", dir: "Wismarer Str" }, { line: "184", dir: "Saaleckstr" }, { line: "184", dir: "Lichterfelde Ost" }], [{ line: "248", dir: "Warschauer Str" }, { line: "248", dir: "Ostbahnhof" }, { line: "248", dir: "Alexanderplatz" }, { line: "248", dir: "Hallesches Tor" }]]];
          break;
        case "BTHF":
          this.stop = [900000068201, 900000068272];
          this.filter = [[[this.S41], [this.S45.SKR], this.getStation(this.S46, 'GB', 'WED', 'WH', 'BEU', 'JUN', 'WES', 'MN', 'WKRR', 'HAL', 'HO', 'HEI', 'BUP', 'IP', 'SGR', 'SKR'), [this.S42], this.getStation(this.S45, 'GAS', 'FLH', 'GBA', 'AGL', 'ADL', 'SCF', 'SW', 'BMW', 'KHD', 'NK', 'HER'), this.getStation(this.S46, 'KW', 'WI', 'ZTH', 'EIW', 'GAS', 'ADL', 'SCF', 'SW', 'BMW', 'KHD', 'NK', 'HER'), this.getStation(this.U6, 'Tg', 'Bk', 'Hh', 'OTI', 'Scha', 'Sch', 'Afr', 'Rb', 'Se', 'Lpo', 'We', 'Ri', 'SK', 'NA', 'Ob', 'F', 'Fr', 'Mic', 'Ks', 'Hu', 'Me', 'PL', 'Ps'), this.getStation(this.U6, 'Mf', 'Wl', 'Ull', 'At'), [{ line: "184", dir: "Südkreuz" }], [{ line: "N6", dir: "Alt-Tegel"}], [{ line: "140", dir: "Ostbahnhof" }, { line: "140", dir: "Mehringdamm" }], [{ line: "184", dir: "Warthestr" }, { line: "184", dir: "Wismarer Str" }, { line: "184", dir: "Saaleckplatz" }, { line: "184", dir: "Lichterfelde Ost" }], [{ line: "N6", dir: "Alt-Mariendorf" }], [{ line: "N84", dir: "Zehlendorf Eiche" }, { line: "N84", dir: "Alt-Tempelhof" }]], [[{ line: "184", dir: "Südkreuz" }, { line: "184", dir: "Tempelhof" }], [{ line: "N6", dir: "Alt-Tegel" }], [{ line: "184", dir: "Warthestr" }, { line: "184", dir: "Wismarer Str" }, { line: "184", dir: "Saaleckplatz" }, { line: "184", dir: "Lichterfelde Ost" }], [{ line: "N6", dir: "Alt-Mariendorf" }]]];
          break;
        case "BTP":
          this.stop = [900000190001, 900000190701, 900000190702, 900000190100];
          this.filter = [[[this.S41], this.getStation(this.S45, 'GAS', 'FLH', 'GBA', 'AGL', 'ADL', 'SCF', 'SW', 'BMW', 'PWA'), this.getStation(this.S46, 'KW', 'WI', 'ZTH', 'EIW', 'GAS', 'ADL', 'SCF', 'SW', 'BMW', 'PWA'), this.getStation(this.S47, 'SPF', 'OSP', 'SW', 'BMW', 'PWA'), this.getStation(this.S8, 'ZTH', 'EIW', 'GAS', 'ADL', 'SCF', 'SW', 'BMW', 'PWA'), this.getStation(this.S85, 'GAS', 'ADL', 'SCF', 'SW', 'BMW', 'PWA'), this.getStation(this.S9, 'GAS', 'FLH', 'GBA', 'AGL', 'ADL', 'SCF', 'SW', 'BMW', 'PWA'), [this.S42], this.getStation(this.S8, 'BIW', 'HN', 'BFE', 'SNF', 'MM', 'BLB', 'PHD', 'PKW', 'BOS', 'SAL', 'PLA', 'GSS', 'LST', 'STO', 'FA', 'OK'), this.getStation(this.S85,'NB', 'HUM', 'GB', 'PKW', 'BOS', 'SAL', 'PLA', 'GSS', 'LST', 'STO', 'FA', 'OK'), this.getStation(this.S9, 'GWD', 'SPA', 'SRW', 'PIC', 'OLS', 'HST', 'MS', 'WKS', 'CHS', 'SAP', 'ZOS', 'TGN', 'BEV', 'HBF', 'FST', 'HKM', 'ALX', 'JB', 'OSB', 'WRS')], [[{ line: "165", dir: "Märkisches Museum" }, { line: "165", dir: "Treptower Park" }], [{ line: "166", dir: "Boddinstr" }, { line: "166", dir: "Treptower Park" }], [{ line: "265", dir: "Stadtmitte" }, { line: "265", dir: "Märkisches Museum" }, { line: "265", dir: "Schlesisches Tor" }, { line: "265", dir: "Treptower Park" }], [{ line: "N65", dir: "Hackescher Markt" }]], [[{ line: "104", dir: "Brixplatz" }, { line: "104", dir: "Theodor-Heuss-Platz" }, { line: "104", dir: "Berliner Str" }, { line: "104", dir: "Platz der Luftbrücke" }, { line: "104", dir: "Boddinstr" }], [{ line: "194", dir: "Hermannplatz" }], [{ line: "N94", dir: "Hermannplatz" }], [{ line: "104", dir: "Tunnelstr" }], [{ line: "194", dir: "Helene-Weigel-Platz" }, { line: "194", dir: "Friedrichsfelde Ost" }, { line: "194", dir: "Nöldnerplatz" }], [{ line: "N94", dir: "Magdalenenstr" }]], [[{ line: "104", dir: "Brixplatz" }, { line: "104", dir: "Theodor-Heuss-Platz" }, { line: "104", dir: "Berliner Str" }, { line: "104", dir: "Platz der Luftbrücke" }, { line: "104", dir: "Boddinstr" }], [{ line: "165", dir: "Müggelschlößchenweg" }, { line: "165", dir: "Schöneweide" }], [{ line: "166", dir: "Boddinstr" }], [{ line: "194", dir: "Hermannplatz" }], [{ line: "265", dir: "Schöneweide" }, { line: "265", dir: "Baumschulenstr" }], [{ line: "N65", dir: "Müggelschlößchenweg" }, { line: "N65", dir: "Schöneweide" }], [{ line: "N94", dir: "Hermannplatz" }], [{ line: "165", dir: "Märkisches Museum" }], [{ line: "265", dir: "Stadtmitte" }, { line: "265", dir: "Märkisches Museum" }, { line: "265", dir: "Schlesisches Tor" }], [{ line: "N65", dir: "Hackescher Markt" }]]];
          break;
        case "BWRS":
          this.stop = [900000120004, 900000120011, 900000120020, 900000120021];
          this.filter = [[this.getStation(this.S3, 'GWD', 'SPA', 'SRW', 'PIC', 'OLS', 'HST', 'MS', 'WKS', 'CHS', 'SAP', 'ZOS', 'TGN', 'BEV', 'HBF', 'FST', 'HKM', 'ALX', 'JB', 'OSB'), this.getStation(this.S5, 'GWD', 'OLS', 'HST', 'MS', 'WKS', 'CHS', 'SAP', 'ZOS', 'TGN', 'BEV', 'HBF', 'FST', 'HKM', 'ALX', 'JB', 'OSB'), this.getStation(this.S7, 'OLS', 'HST', 'MS', 'PDH', 'BAB', 'GRI', 'WSS', 'NIS', 'GWD', 'WKS', 'CHS', 'SAP', 'ZOS', 'TGN', 'BEV', 'HBF', 'FST', 'HKM', 'ALX', 'JB', 'OSB'), [this.S75.OSB], this.getStation(this.S9, 'GWD', 'SPA', 'SRW', 'PIC', 'OLS', 'HST', 'MS', 'WKS', 'CHS', 'SAP', 'ZOS', 'TGN', 'BEV', 'HBF', 'FST', 'HKM', 'ALX', 'JB', 'OSB'), this.getStation(this.S3, 'E', 'WIG', 'RD', 'FRH', 'HIG', 'KPK', 'WHH', 'KLH', 'RB', 'RH', 'OKS'), this.getStation(this.S5, 'STN', 'STR', 'HGM', 'STV', 'PEN', 'FD', 'NG', 'HPG', 'BIS', 'MDF', 'KAD', 'WT', 'BDF', 'FFO', 'LI', 'NPL', 'OKS'), this.getStation(this.S7, 'AF', 'MEA', 'RW', 'MAZ', 'POE', 'SPH', 'FFO', 'LI', 'NPL', 'OKS'), this.getStation(this.S75, 'WAB', 'HH', 'GSE', 'SPH', 'FFO', 'LI', 'NPL', 'OKS'), this.getStation(this.S9, 'LI', 'NPL', 'OKS', 'GAS', 'FLH', 'GBA', 'AGL', 'ADL', 'SCF', 'SW', 'BMW', 'PWA', 'TP'), [this.U1.NULL], [this.U3.NULL], [{line: "M10", dir: "Hauptbahnhof"}, {line: "M10", dir: "Friedrich-Ludwig-Jahn-Sportpark"}], [{line: "347", dir: "Ostbahnhof"}], [{line: "N1", dir: "Helsingforser Platz"}], [{line: "347", dir: "Tunnelstr"}], [{line: "N1", dir: "Zoologischer Garten"}], [{line: "248", dir: "Breitenbachplatz"}, {line: "248", dir: "Südkreuz"}, {line: "248", dir: "Hallesches Tor"}, {line: "248", dir: "Alexanderplatz"}, {line: "248", dir: "Ostbahnhof"}]], [[{line: "M10", dir: "Hauptbahnhof"}, {line: "M10", dir: "Friedrich-Ludwig-Jahn-Sportpark"}], [{line: "M10", dir: "Warschauer Str"}]], [[{line: "347", dir: "Ostbahnhof"}], [{line: "347", dir: "Tunnelstr"}], [{line: "N1", dir: "Zoologischer Garten"}]], [[{line: "M10", dir: "Hauptbahnhof"}, {line: "M10", dir: "Friedrich-Ludwig-Jahn-Sportpark"}], [{line: "M13", dir: "Virchow-Klinikum"}, {line: "M13", dir: "Degnerstr"}, {line: "M13", dir: "Betriebshof Lichtenberg"}]]];
          break;
        case "BWED":
          this.stop = [900000009104, 900000008103];
          this.filter = [[[this.S41], [this.S46.GB], [this.S42], this.getStation(this.S46, 'KW', 'WI', 'ZTH', 'EIW', 'GAS', 'ADL', 'SCF', 'SW', 'BMW', 'KHD', 'NK', 'HER', 'THF', 'SKR', 'SGR', 'IP', 'BUP', 'HEI', 'HO', 'HAL', 'WKRR', 'MN', 'WES', 'JUN', 'BEU', 'WH'), this.getStation(this.U6, 'Tg', 'Bk', 'Hh', 'OTI', 'Scha', 'Sch', 'Afr', 'Rb', 'Se', 'Lpo'), this.getStation(this.U6, 'Mf', 'Wl', 'Ull', 'Ka', 'At', 'Ts', 'Ps', 'PL', 'Me', 'Ks', 'Mic', 'Fr', 'F', 'Ob', 'NA', 'SK', 'Ri'), [{ line: "120", dir: "Wilhelmsruher Damm" }, { line: "120", dir: "Wittenau" }, { line: "120", dir: "Paracelsus-Bad" }, { line: "120", dir: "Leopoldplatz" }], [{ line: "N6", dir: "Alt-Tegel" }], [{ line: "N20", dir: "Hainbuchenstr" }]], [[{ line: "M27", dir: "Jungfernheide" }], [{ line: "247", dir: "Leopoldplatz" }], [{ line: "M27", dir: "Pankow" }], [{ line: "247", dir: "Nordbahnhof" }, { line: "247", dir: "Bernauer Str" }]]];
          break;
        case "BWES":
          this.stop = [900000026207,900000020204];
          this.filter = [[[this.S41], this.getStation(this.S46, 'GB', 'WED', 'WH', 'BEU', 'JUN'), [this.S42], this.getStation(this.S46, 'KW', 'WI', 'ZTH', 'EIW', 'GAS', 'ADL', 'SCF', 'SW', 'BMW', 'KHD', 'NK', 'HER', 'THF', 'SKR', 'SGR', 'IP', 'BUP', 'HEI', 'HO', 'HAL', 'WKRR', 'MN'), [{ line: "M45", dir: "Johannesstift" }, { line: "M45", dir: "DRK-Kliniken Westend" }, { line: "M45", dir: "Rathaus Spandau" }], [{ line: "M45", dir: "Zoologischer Garten" }]],[[{line: "M45", dir: "Johannesstift"},{line: "M45", dir: "Rathaus Spandau"},{line: "M45", dir: "DRK-Kliniken Westend"}], [{line: "309", dir: "Schlosspark-Klinik"}],[{line: "M45", dir: "Zoologischer Garten"}], [{line: "309", dir: "Wilmersdorfer"}]]];
          break;
        case "BWH":
          this.stop = [900000001201];
          this.filter = [[[this.S41], [this.S46.GB, this.S46.WED], [this.S42], this.getStation(this.S46, 'KW', 'WI', 'ZTH', 'EIW', 'GAS', 'ADL', 'SCF', 'SW', 'BMW', 'KHD', 'NK', 'HER', 'THF', 'SKR', 'SGR', 'IP', 'BUP', 'HEI', 'HO', 'HAL', 'WKRR', 'MN', 'WES', 'JUN', 'BEU'), this.getStation(this.U9, 'Olo', 'Np', 'Lpu', 'Am'), this.getStation(this.U9, 'Rzu', 'Sl', 'Wsg', 'Fw', 'Bd', 'Beo', 'Gt', 'Snu', 'Kfu', 'Zu', 'Ha', 'Tm', 'Bi'), [{ line: "N9", dir: "Osloer Str" }], [{ line: "N9", dir: "Rathaus Steglitz" }, { line: "N9", dir: "Zoologischer Garten" }]]];
          break;
          this.stop = [900000024102];
          this.filter = [[this.getStation(this.S3, 'GWD', 'SPA', 'SRW', 'PIC', 'OLS', 'HST', 'MS'), this.getStation(this.S5, 'GWD', 'OLS', 'HST', 'MS'), this.getStation(this.S7, 'OLS', 'HST', 'MS', 'PDH', 'BAB', 'GRI', 'WSS', 'NIS', 'GWD'), this.getStation(this.S9, 'GWD', 'SPA', 'SRW', 'PIC', 'OLS', 'HST', 'MS'), this.getStation(this.S3, 'E', 'WIG', 'RD', 'FRH', 'HIG', 'KPK', 'WHH', 'KLH', 'RB', 'RH', 'OKS', 'WRS', 'OSB', 'JB', 'ALX', 'HKM', 'FST', 'HBF', 'BEV', 'TGN', 'ZOS', 'SAP', 'CHS'), this.getStation(this.S5, 'STN', 'STR', 'HGM', 'STV', 'PEN', 'FD', 'NG', 'HPG', 'BIS', 'MDF', 'KAD', 'WT', 'BDF', 'FFO', 'LI', 'NPL', 'OKS', 'WRS', 'OSB', 'JB', 'ALX', 'HKM', 'FST', 'HBF', 'BEV', 'TGN', 'ZOS', 'SAP', 'CHS'), this.getStation(this.S7, 'AF', 'MEA', 'RW', 'MAZ', 'POE', 'SPH', 'FFO', 'LI', 'NPL', 'OKS', 'WRS', 'OSB', 'JB', 'ALX', 'HKM', 'FST', 'HBF', 'BEV', 'TGN', 'ZOS', 'SAP', 'CHS'), this.getStation(this.S9, 'LI', 'NPL', 'OKS', 'GAS', 'FLH', 'GBA', 'AGL', 'ADL', 'SCF', 'SW', 'BMW', 'PWA', 'TP', 'WRS', 'OSB', 'JB', 'ALX', 'HKM', 'FST', 'HBF', 'BEV', 'TGN', 'ZOS', 'SAP', 'CHS'), [this.S41], this.getStation(this.S46, 'GB', 'WED', 'WH', 'BEU', 'JUN', 'WES', 'MN'), [this.S42], this.getStation(this.S46, 'KW', 'WI', 'ZTH', 'EIW', 'GAS', 'ADL', 'SCF', 'SW', 'BMW', 'KHD', 'NK', 'HER', 'THF', 'SKR', 'SGR', 'IP', 'BUP', 'HEI', 'HO', 'HAL'), [{ line: "104", dir: "Brixplatz" }, { line: "104", dir: "Theodor-Heuss-Platz" }], [{ line: "N42", dir: "Theodor-Heuss-Platz" }]]];
          break;
        case "jov":
  ...
  addS7() {
    this.S7 = this.addBLine("S7", {AF: "Ahrensfelde", MEA: "Mehrower Allee", RW: "Raoul-Wallenberg-Str", MAZ: "Marzahn", POE: "Poelchaustr", SPH: "Springpfuhl", FFO: "Friedrichsfelde Ost", LI: "Lichtenberg", NPL: "Nöldnerplatz", OKS: "Ostkreuz", WRS: "Warschauer Str", OSB: "Ostbahnhof", JB: "Jannowitzbrücke", ALX: "Alexanderplatz", HKM: "Hackescher Markt", FST: "Friedrichstr", HBF: "Hauptbahnhof", BEV: "Bellevue", TGN: "Tiergarten", ZOS: "Zoologischer Garten", SAP: "Savignyplatz", CHS: "Charlottenburg", WKS: "Westkreuz", GWD: "Grunewald", NIS: "Nikolassee", WSS: "Wannsee", GRI: "Griebnitzsee", BAB: "Babelsberg", PDH: "Potsdam", MS: "Messe Süd", HST: "Heerstr", OLS: "Olympiastadion", NULL: null});
  }
  addS75() {
  ...
  checkWarning(array){
    for(let i = 0; i < array.length; i++){
      ...
      if(array[i].type == "warning"){
        return `<span class="fas fa-exclamation-triangle" title="${array[i].validFrom} - ${array[i].validUntil}: ${summary}, ${text}">&nbsp;</span>`
      }
    }
    return "";
  }
